...
inline auto Multiply(const TMatrix3 &a, const TMatrix3 &b) noexcept -> TReturn {
    return a * b;
}
 ...
 */
template <typename TVector>
inline auto CrossMultiply(const TVector &vec1, const TVector &vec2) noexcept ->
    typename TVector::ValueType {
    return vec1 % vec2;
}
...
inline auto Multiply(const TMatrix3 &mat, const TVector &vec) noexcept
    -> TVector {
    return mat * vec;
}
...
inline auto MatrixTranslate(const TValueType &dx, const TValueType &dy) noexcept
    -> ne::BasicMatrix3<TValueType> {
...
inline auto MatrixTranslate(const TMatrix3 &mat,
                            const typename TMatrix3::ValueType &dx,
                            const typename TMatrix3::ValueType &dy) noexcept
    -> TMatrix3 {
 ...
 */
template <typename TValueType>
inline auto MatrixScale(const TValueType &sx, const TValueType &sy) noexcept
    -> ne::BasicMatrix3<TValueType> {
 ...
 */
template <typename TMatrix3>
inline auto MatrixScale(const TMatrix3 &mat,
                        const typename TMatrix3::ValueType &sx,
                        const typename TMatrix3::ValueType &sy) noexcept
    -> TMatrix3 {
 ...
 */
template <typename TValueType>
inline auto MatrixRotate(const TValueType &angle) noexcept
    -> ne::BasicMatrix3<TValueType> {
 ...
 */
template <typename TMatrix3>
inline auto MatrixRotate(const TMatrix3 &mat,
                         const typename TMatrix3::ValueType &angle) noexcept
    -> TMatrix3 {
 ...
 */
template <typename TValueType>
inline auto FromLTRB(const TValueType &left,
                     const TValueType &top,
                     const TValueType &right,
                     const TValueType &bottom) noexcept
    -> BasicRectangle<TValueType> {
